...
FORM={
 ...
 'reference':q('reference','Is the formula described in an authoritative First-Schedule text?','क्या सूत्र प्रथम अनुसूची के प्रामाणिक ग्रंथ में है?','सूत्र प्रथम अनुसूचीतील अधिकृत ग्रंथात आहे का?',YESNO),
 'exact':q('exact','Are the ingredients, proportions and preparation method unchanged from that text?','क्या सामग्री, अनुपात और विधि ग्रंथ के समान हैं?','घटक, प्रमाण आणि कृती त्या ग्रंथाप्रमाणेच आहेत का?',YESNO),
 'ingredients':q('ingredients','Are all medicinal ingredients described in the authoritative texts?','क्या सभी औषधीय घटक प्रामाणिक ग्रंथों में वर्णित हैं?','सर्व औषधी घटक अधिकृत ग्रंथांमध्ये वर्णिले आहेत का?',YESNO),
 'phytopharma':q('phytopharma','Is this a standardized plant fraction being developed through the phytopharmaceutical route?','क्या यह फाइटोफार्मास्यूटिकल मार्ग का मानकीकृत पौध अंश है?','हे फायटोफार्मास्युटिकल मार्गाने विकसित होणारे प्रमाणित वनस्पती अंश आहे का?',YESNO),
 'aahara':q('aahara','Does the food follow an Ayurveda-Aahara recipe or applicable authoritative-text basis?','क्या भोजन आयुर्वेद आहार की विधि या प्रामाणिक ग्रंथ पर आधारित है?','अन्न आयुर्वेद आहार कृती किंवा अधिकृत ग्रंथावर आधारित आहे का?',YESNO),
 'route':q('route','How will it be administered?','इसे कैसे उपयोग किया जाएगा?','ते कसे वापरले जाईल?',[
    ('oral','Oral','मुख से','तोंडावाटे'),('external','External','बाहरी','बाह्य'),('other','Other / not established','अन्य / अस्पष्ट','इतर / अस्पष्ट')]),
 'origin':q('origin','What biological materials are involved?','कौन सी जैविक सामग्री शामिल है?','कोणती जैविक सामग्री आहे?',[
